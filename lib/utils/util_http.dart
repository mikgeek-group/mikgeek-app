...
import 'package:mkapp/config.dart';
import 'package:get/get.dart' hide FormData;
import 'package:mkapp/constant/cache_constant.dart';

class UtilHttp {
  static UtilHttp _instance = UtilHttp._internal();
  ...
  UtilHttp._internal() {
    ...
    dio.interceptors.add(InterceptorsWrapper(
      onRequest: (options, handler) {
        print("接口请求路径：${options.path}");
        print("接口请求方法：${options.method}");
      ...
      case DioErrorType.response:
        {
          try {
            ...
            // EasyLoading.showToast(error.response!.data['message']);
            switch (errCode) {
              case 400:
